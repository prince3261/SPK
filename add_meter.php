    ...
    function addMeterGroup() {
        ...
        newGroup.innerHTML = `
            <div class="form-group">
                ...
                <select name="room_id[]" required onchange="calculateMeterPrice(this.parentElement.parentElement)">
            ...
            <div class="form-group">
                ...
                <input type="text" name="meter_value[]" class="meter_value" required oninput="calculateMeterPrice(this.parentElement.parentElement)">
            </div>
            <div class="form-group">
